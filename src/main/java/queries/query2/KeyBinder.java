...
/*public class KeyBinder
    ...
    @Override
    public void process(String key, Context context, Iterable<Tuple2<Integer, Integer>> iterable, Collector<Tuple2<String, Tuple2<Integer, Integer>>> collector) throws Exception {
